...
p_err = @pgf Axis(
    ...
    PlotInc({lineopts..., color=color_jDMD, solid, thick}, Coordinates(alpha, jdmd_err_cl_filtered)),
    ...
    PlotInc({lineopts..., "cyan!50", dashed, thick}, Coordinates(alpha, jdmd_err_ol_filtered)),
