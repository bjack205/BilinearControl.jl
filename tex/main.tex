...
\begin{figure}[t]
  ...
  \begin{subfigure}[t]{0.48\textwidth}
    \includegraphics[width=\textwidth, height=4cm]{../images/cartpole_mpc_test_error.tikz}
  ...
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    % \includegraphics[width=\textwidth, height=5cm]{lab_planar_quadrotor_mpc_test_error.tikz}
...
\begin{figure}[t] \centering
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth,height=4.5cm]{lab_planar_quadrotor_lqr_error_by_equilibrium_change.tikz}
    \caption{LQR stabilization error over increasing equilibrium offset}
    \label{fig:lab_planar_quadrotor_lqr_error_by_equilibrium_change}
  \end{subfigure}
  \hfill
  \begin{subfigure}[t]{0.48\textwidth}
    \raggedright
    \includegraphics[width=\textwidth, height=4.5cm]{lab_planar_quadrotor_mpc_error_by_training_window.tikz}
    \caption{Tracking error for the quadrotor MPC reference trajectory tracking task.}
    \label{fig:lab_planar_quadrotor_mpc_error_by_training_window}
    % \includegraphics[width=\textwidth,height=5cm]{lab_planar_quadrotor_lqr_error_by_training_window.tikz}
    % \caption{Stabilization error for the quadrotor LQR stabilization task}
    % \label{fig:lab_planar_quadrotor_lqr_error_by_training_window}
  \end{subfigure}
...
\begin{wraptable}{r}{7.0cm}
	...
	% 	\bottomrule
	% \end{tabular}
  \input{"../images/tables/full_quad_mpc.tex"}
...
\ref{fig:lab_planar_quadrotor_mpc_error_by_training_window}. With a well-picked 
regularization value, JDMD generalized past where the performance of EDMD suffers. 
Additionally, in Figure \ref{fig:lab_planar_quadrotor_lqr_error_by_equilibrium_change} we 
...
are nearly inverted (see Figure \ref{fig:lab_full_quadrotor_initial_conditions}). 
...
% stabilization (Figure \ref{fig:lab_planar_quadrotor_lqr_error_by_equilibrium_change}) and 
% trajectory tracking (Figure \ref{fig:lab_planar_quadrotor_mpc_error_by_training_window})
...
% In Figure \ref{fig:lab_planar_quadrotor_lqr_error_by_equilibrium_change} we show the effect 
...
% with full attitude dynamics. As seen in Figure \ref{fig:lab_full_quadrotor_initial_conditions}, the generated
...
\begin{figure}[t] \centering
	\begin{subfigure}[t]{0.49\textwidth}
		...
		\label{fig:lab_full_quadrotor_initial_conditions}
	\end{subfigure}
	\hfill
	\begin{subfigure}[t]{0.49\textwidth}
		\raggedright
