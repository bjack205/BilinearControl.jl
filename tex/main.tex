...
\section{Introduction}
    ...
    \cite{Meduri2022,Bruder2021,Korda2018,Folkestad2020,Folkestad2020a,Suh2020}
...
\section{Background and Related Work} \label{sec:Preliminaries/Background}
  ...
  maximal-coordinate representations of rigid body dynamics \cite{baraff_linear-time_1996-1}
   \todo{add citations}, the
...
Each controller was tested using 100 different initial conditions sampled
from a uniform distribution of initial conditions
