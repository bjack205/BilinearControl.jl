...
\todo{update quadotor description} For the planar quadrotor, the \textit{true} model
...
with just two sample trajectories, and achieves uniformly better than eDMD on both 
