...
\begin{figure}[t] \centering
  \begin{subfigure}[t]{0.49\textwidth}
    \centering
    \includegraphics[width=\textwidth,height=4.5cm]{rex_planar_quadrotor_lqr_error_by_equilibrium_change.tikz}
  ...
  \begin{subfigure}[t]{0.48\textwidth}
    \raggedright
    \includegraphics[width=\textwidth, height=4.5cm]{rex_planar_quadrotor_mpc_error_by_training_window.tikz}
