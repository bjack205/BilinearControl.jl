...
\begin{figure}[t] \centering
	\begin{subfigure}[t]{0.49\textwidth}
		...
		\caption{Sampled point-to-point trajectories and initial conditions for test
		tracking MPC of 6-DOF quadrotor (top-down view).}
...
usually had better performance than it's lifted counterpart that used the bilinear
