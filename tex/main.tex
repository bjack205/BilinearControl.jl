...
both the cartpole swing up and the quadrotor trajectory tracking tasks, the proposed method
...
%     (17 states), whereas the ``Projected'' MPC controllers project the Jacobians of the 
